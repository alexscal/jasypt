...
public class EncryptablePropertiesTest extends TestCase {
    ...
    public void testEncryptablePropertiesSerialization() throws Exception {
        ...
        assertEquals(prop01.getProperty("p1"), msg01);
        assertEquals(prop01.getProperty("p2"), msg02);
        ...
        assertEquals(prop02.getProperty("p1"), msg01);
        assertEquals(prop02.getProperty("p2"), msg02);
    
        assertNotSame(prop01, prop02);
